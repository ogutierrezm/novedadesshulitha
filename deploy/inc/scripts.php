		...
		<!-- <script src=" < ASSETS_URL >/js/speech/voicecommand.min.js"></script> -->		

		<!-- SmartChat UI : plugin -->
		<!-- <script src="< ASSETS_URL >/js/smart-chat-ui/smart.chat.ui.min.js"></script> -->
		<!-- script src="< ASSETS_URL  >/js/smart-chat-ui/smart.chat.manager.min.js"></script> -->
		
		<!-- Se relacionan funciones de login y de mas!-->
		<script src="<?php echo ASSETS_URL; ?>/js/piscis/funciones.js" type="text/javascript"></script>

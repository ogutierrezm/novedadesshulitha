...
(function ($) {
        ...
        jTimeout.countdown = function () {
            ...
            if (seconds < 0 && !$timedOut) {
                ...
                if (!jTimeout.options.onTimeout) {
                   ...
                   /* $.jAlert({
                        'id': 'jTimedoutAlert',
                        'title': 'Tu sesi&oacute;n a finalizado!',
                        'content': '<b>Favor de iniciar sesi&oacute;n.</b>',
                        'theme': 'red',
                        'btns': {
					...
					$.SmartMessageBox({
						title : "Tu sesi&oacute;n a expirado!",
						content : "",
						buttons : '[Iniciar]'
            ...
            /* If less than x + 2 seconds left and not warned yet, show warning */
                ...
                if (!jTimeout.options.onPriorCallback) {
                    $.jAlert({
                        'id': 'jTimeoutAlert',
                        'title': 'Tu sesi&oacute;n est&aacute; por cerrarse!',
                        'content': '<b>Tu sesi&oacute;n est&aacute; por terminar en <span class="jTimeout_Countdown">' + seconds + '</span> segundos!</b>',
                        'theme': 'red',
                        'closeBtn': false,
    ...
    $.jTimeout.defaults = {
        ...
        'flashingTitleText': '**Sesion Expira**', //what to show in the tab/title bar when about to timeout, or after timing out
        ...
        'timeoutAfter': vTiempoSesion, //1440, //pass this from server side to be fully-dynamic. For PHP: ini_get('session.gc_maxlifetime'); - 1440 is generally the default timeout
        ...
        'extendUrl': 'logout.php', //URL to request in order to extend the session.
        ...
        'loginUrl': 'logout.php', //URL to send a customer when they want to log back in

        'secondsPrior': 0,//60, //how many seconds before timing out to run the next callback (onPriorCallback)

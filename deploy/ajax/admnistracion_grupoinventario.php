				...
				<div>
					...
					<div class="widget-body no-padding">
							...
							<form action="" id="admon_zonas" class="smart-form">
								<header>
									<h3>Agregar un grupo de inventario</h3>
								</header>
								<!-- cabecero --><!-- -->								 
								<!-- datos de la zona -->
								<fieldset>
									<div class="row">										
										<section class="col col-3">
											...
											<label class="input"><i class="icon-prepend fa fa-tag"></i>
												<input type="text" id="nombre" name="nombre" placeholder="Grupo uno"  onkeypress="return isAlphaNumeric(event);" maxlength="80">
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6">
												...
												<label class="textarea"><i class="icon-prepend fa fa-comment"></i>									
													<textarea rows="3" id="descripcion" name="descripcion" placeholder="Caracteristicas del grupo..." onkeypress="return isAlphaNumeric(event);" maxlength="120"></textarea> 
												</label>
										</section>
									</div> 
									<div class="col-sm-12">
								...
								<footer>
										<button type="button" class="btn btn-primary" onclick="CreateNvoGrupo();">
									  ...
									  <hr>								  							 
										<!-- <section class="col col-10"> -->
											<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												...
												<tbody id="tbodyZonas">
													<?PHP
														$sRespuesta =LlenarGridGrupoInventario();

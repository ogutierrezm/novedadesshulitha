				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="" id="admon_desctos" class="smart-form">
								...
								<div class="row">										
									<section class="col col-3">
										...
										<label class="input"><i class="icon-prepend fa fa-tag"></i>
											<input id="Descuento" name="Descuento" placeholder="%10"  onkeyup="return isCorrectNumber(event,this);" onblur="return SetValores(this);" maxlength="3" max="30" type="number" VALUE="<?PHP echo $Valores['valor'];?>">
										</label>
									</section>
								</div>
								<div class="col-sm-12">
							...
							<footer>
									<button type="button" class="btn btn-primary" onclick="return ModificarDescuento();">

<?php 
	...
	$articulosPedido = ArticulosUnaCotizacion($folio);	
				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="" id="registrar_pedido" class="smart-form" novalidate="novalidate">
							...
							<fieldset>							
									<div class="row">
										<section class="col col-4 pull-left">
											<h2 class="page-title txt-color-blueDark" id="idTituloModCotizacion">
									...
									<section class="col col-11">
										<div class="table-responsive">
											...
											<section class="col col-2" style="display:none">
												...
												<label class="input"> <i class="icon-prepend fa fa-money"></i>
													<input id="importe_totalmodal" name="importe_totalmodal" type="text" placeholder="$100" value="0" onkeyup="return ReCalcularSaldoPedidoModifica(1);" onkeypress="return isNumber(event);" onfocus="this.select();" onblur="return SetValoresDefault(this,2);">	
												</label>
											</section>
							...
							<fieldset>
								...
								<div class="row">
									<section class="col col-4">
										...
										<label class="input"> <i class="icon-prepend fa fa-phone"></i>
											<input type="tel" id="telefonocelular" name="telefonocelular" onfocus="this.select();" placeholder="(667) 123-4567" onkeydown="return ConsultarTelefonoCelularCte();" onblur="return ConsultarTelefonoCelularCte();" onkeypress="return isNumber(event);">
										</label>
									</section>
									<section class="col col-4">
										<label class="label"><sup>*</sup> Tel&eacute;fono fijo </label>
										<label class="input"> <i class="icon-prepend fa fa-phone"></i>
											<input type="tel" id="telefonocasa" name="telefonocasa" onfocus="this.select();" placeholder="(667) 723-4567" onkeydown="return ConsultarTelefonoCasaCte();" onblur="return ConsultarTelefonoCelularCte();" onkeypress="return isNumber(event);">
										</label>
									</section>										 
									<section class="col col-3">
										<label class="label">&nbsp;<!-- Llenar datos del cliente --></label>
							...
							<footer>
								<button type="button" class="btn btn-primary" id="btnGrabarCotizacion" onclick="return modificarCotizacion();">

				...
				<div>
					<div class="widget-body no-padding">
						<table id="datatable_tabletools" class="table table-striped table-bordered table-hover"  width="100%"  style="margin: 0px;padding:0;" border="0" cellspacing="0" cellpadding="0">
								<thead>
									<tr>
										<th data-class="expand" style=" font-family:Arial;font-size: 16px;text-align:center;"><strong><br/>PEDIDOS PENDIENTE POR DEVOLVER DEP&Oacute;SITO</strong></th>
									</tr>
								</thead>
								<tbody id="tBodyRpt">
									<?PHP
										$PedidosPendientesDevolverDeposito= PedidosPendientesDevolverDeposito();
										echo $PedidosPendientesDevolverDeposito['data'];
									?>								
								</tbody>
							</table>
					</div>
...
<script type="text/javascript"> 
	...
	var sUrlRedirected = "#ajax/reportes_depositospendientes.php";
	var vFlagReload =1;
</script>

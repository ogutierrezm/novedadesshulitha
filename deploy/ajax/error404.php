...
<style>
	.error-text-2 {
		...
		line-height: 1;
		letter-spacing: -.05em;
		background-image: -webkit-linear-gradient(92deg,#333,#29415F);
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box">
					...
					<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i>:( Algo va <u>mal</u>.</strong></h2>
					<br />
					<p class="lead">
						 La p&aacute;gina que buscas no existe o se ha producido un error inesperado.
					</p>
					<p class="font-md">
						<b>Pero no te preocupes, ve al men&uacute; principal y si el problema persiste contacta al administrador del sitio e informale de lo ocurrido. </b>
					</p>
					<br>					 
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<ul class="list-inline">
								<li>
									&nbsp;<a href="#ajax/Dashboard.php">Agenda</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#ajax/capturar_pedido.php">Capturar pedido</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#ajax/recibir_pedido.php">Recibir pedido</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#ajax/inventario.php">Inventario</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#ajax/reportes_inventario.php">Reportes</a>&nbsp;
								</li>
							</ul>
						</div>

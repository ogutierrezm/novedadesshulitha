	...
	<div class="row">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-20" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" >				 
				...
				<div>
					<div class="widget-body no-padding">
							...
							<!--table id="datatable_tabletools" class="table table-striped table-bordered table-hover cell-border"  width="100%"  style="margin: 0px;padding:0;" border="0" cellspacing="0" cellpadding="0"-->
								<thead>
									<tr style="text-aling:center">
										<th colspan="8">CORTE DE CAJA PARCIAL</th>
									</tr>
									<tr>
										<th>Empleado</th>
										<th>Numero abonos</th>
								...
								<tbody id="tbTotalesrpt">
									<?PHP 	$vRespuesta =abonosPagosResumeDetalleEmpleados();
		...
		<div class="col col-4 pull-right">	 
			<fieldset> 
				...
				<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return MensajeSmartCorteAbonos();">

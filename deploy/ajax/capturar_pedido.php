											...
											<table class="table table-bordered" id="tb_detallepedido">
												...
												<tbody id="tabla">
													<tr id="row_1">
														...
														<td ><input id="cantidad_1" name="cantidad" class="form-control input-md" placeholder="1" type="text" onkeyup="isNumber(event); ReCalcularSaldoPedido(1);" onkeydown="isNumber(event);ReCalcularSaldoPedido(1); validaEnter(event,1);" onkeypress="return isNumber(event);" onblur='return  validaBlur(1);' onfocus="this.select();"></td>
...
<script type="text/javascript">
	...
	$("#agregar_fila").click(function(){
			...
			nuevaFila+="<td><input class='form-control input-md' placeholder='1' type='text' id='cantidad_"+ vConsecutivo +"' name='cantidad_"+ vConsecutivo +"' onkeyup='ReCalcularSaldoPedido("+ vConsecutivo +"); isNumber(event);' onfocus='this.select();' onkeydown='isNumber(event); ReCalcularSaldoPedido("+ vConsecutivo +"); validaEnter(event," + vConsecutivo + ");' onblur='return  validaBlur(" + vConsecutivo + ");' onkeypress='return isNumber(event);'></td>";

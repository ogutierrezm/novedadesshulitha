				...
				<div>
					...
					<div class="widget-body no-padding">
						<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
							<thead>
								<tr>
									<th  class="sorting_asc" tabindex="0" aria-controls="datatable_tabletools" rowspan="1" colspan="1" aria-sort="ascending" aria-label="ID: activate to sort column descending" >Zona</th>
									<th data-class="expand">Pedido</th>
								</tr>
							</thead>
							<tbody id="tBodyRpt">
								<?PHP
									$sRespuesta = generarReportePendidosPendientesPorFecha($fecAgenda);

	...
	<div class="row">
					...
					<div class="widget-body no-padding">
						<!-- <div class="PrintArea area1 all" id="Retain"> -->
							<table id="datatable_tabletools" class="table table-striped table-bordered table-hover"  width="100%"  style="margin: 0px;padding:0;" border="0" cellspacing="0" cellpadding="0">
								...
								<tbody id="tBodyRpt">
									<?PHP
										$sRespuestaPorCobrar= generarReportePedidosBorradosAdmin();
		...
		<div class="col col-4 pull-right">	 
			<fieldset> 
				...
				<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return MensajeSmartCorteDescartarBorrados();">

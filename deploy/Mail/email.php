<?php
	...
	function email($email, $subject, $contenido, $cco){
		...
		$mail->SMTPAuth   = true;
		$mail->SMTPDebug  = 1;//0;								// enables SMTP debug information (for testing)
		$mail->SMTPSecure  = "ssl";								// enables SMTP debug information (for testing)
		$mail->Port       = 465;								// set the SMTP server port
		$mail->Host       = "smtp.gmail.com";					// SMTP server
		$mail->Username   = "norbertoelenesgaxiola@gmail.com";//= "apps.bastidas@gmail.com";			// SMTP server username
		$mail->Password   = "nenoj1974";					// SMTP server password
		$mail->SetFrom('norbertoelenesgaxiola@gmail.com', 'Diversiones Piscis');
		$mail->Timeout=30;

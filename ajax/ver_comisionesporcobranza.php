	...
	<div class="row">		
				...
				<div>
					<div class="widget-body no-padding">
						<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%"  style="padding:0;" border="0" cellspacing="0" cellpadding="0">
							...
							<tbody id="tBodyRpt">
								<?PHP
							         $sRespuesta = verComisionesPorCobrador();
		...
		<div class="col col-4 pull-right">	 
			<fieldset> 
				...
				<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return MensajeSmartCorteDescartarPagarComisionesCobranza();">
...
<script type="text/javascript"> 
	...
	function PagarComisionesCobranza(){
		...
		for (var i = 0; i <= vConsecutivo ; i++) {
			...
			if (ControlCheck.checked == true && vFolioPedido > 0) {
				bRespuesta = PagarComisionPorCobranza(vFolioPedido);
				//bRespuesta = false;
			}else{
				continue;
			}

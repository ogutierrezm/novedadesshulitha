...
?>
<script src="js/piscis/cuenta_incobrable.js"/>
	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-4" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
					...
					<div>
						...
						<div class="widget-body no-padding">
								<table id="dt_basic" class="table table-striped table-bordered table-hover" >
									...
									<tbody id="tbodyCuentasIncobrables">
				...
				<!-- end widget div -->
					<a href='ajax/modal_cuenta_incobrable.php' data-toggle='modal' data-target='#remoteModal' id='editarProveedor' class="btn btn-primary btn-lg" style="float:right;">Nuevo</a>
			</div>

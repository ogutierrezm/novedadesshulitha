	...
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return llenarGridAbonosReporteRangosFechas();">
...
<?php
	if(!isset($_REQUEST['tipo']))	{
		echo '<script>llenarGridAbonosReporte();pageConstruirGridAbonos();</script>';
	}
?>
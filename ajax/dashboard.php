	...
	var pagefunction = function() {
	    ...
	    fullviewcalendar = $('#calendar').fullCalendar({
			...
			eventClick: function(calEvent,start, jsEvent, view){
				...
				window.open("#ajax/ver_lista_pedidos.php?fc="+moment(calEvent.start).format('YYYY-MM-DD') , "_self");
			...
			select: function(start,end,jsEvent,view){
				window.open("#ajax/ver_lista_pedidos.php?fc="+moment(start).format('YYYY-MM-DD') , "_self");

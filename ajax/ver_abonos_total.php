...
?>
<script src="js/piscis/abonos.js"/>
...
<?php if(isset($_REQUEST['tipo']) && $_REQUEST['tipo'] == 'rango'){ ?>
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return llenarGridAbonosReporteRangosFechas_2();">
	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class = "row" style="margin-left: 3px;font-size: 16px;color:black">
				<label>Total Abono: <label id="lblTotal" style="margin-left: 3px">$0</label></label>
			</div>
		<!-- END COL -->
...
<script type="text/javascript"> 
	...
	function pageConstruirGridAbonos(){
...
<?php
	if(!isset($_REQUEST['tipo']))	{
		echo '<script>llenarGridAbonosReporte_2();pageConstruirGridAbonos();</script>';
	}
?>
...
?>
<script src="js/piscis/concepto_gastos.js"/>
	...
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return llenarGridGastosReporteRangoFecha();">
				...
				<!-- widget div-->
					<div>
						...
						<div class = "row" style="margin-left: 3px;font-size: 16px;color:black">
							<label>Total Gastos: <label id="totalGastos" style="margin-left: 3px">$0.0</label></label>
						</div>
					</div>
					<!-- end widget content -->
				</div>
...
<script type="text/javascript"> 
	...
	function pageConstruirGridGastos(){
...
<?php
	if(!isset($_REQUEST['tipo']))	{
		echo '<script>llenarGridGastosReporte();pageConstruirGridGastos();</script>';
	}
?>
	...
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return buscarComisionesPagadasPeriodo();">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-12" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" >				 
				<header>					
					...
					<h2>VER COMISIONES PAGADAS <label id="idDel"></label><label id="idAl"></label></h2>
				</header>
				<div>
					<div class="widget-body no-padding">
						<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%"  style="padding:0;" border="0" cellspacing="0" cellpadding="0">
							<thead>
								<tr>
									<th data-class="expand" style="font-family:Arial;font-size: 16px;text-align:center;"><strong>VER COMISIONES PAGADAS <label id="idDelEnc"></label><label id="idAlEnc"></label></strong></th>
								</tr>
							</thead>
							<tbody id="tBodyRpt">								
								<!-- ?PHP
...
<script type="text/javascript"> 
	...
	function PaginarComisionesPagadasPeriodo(){
		// pagefunction	

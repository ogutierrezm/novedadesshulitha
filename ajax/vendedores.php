...
?>
<script src="js/piscis/vendedores.js"/>
	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-4" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<!-- end widget div -->
				<a href='ajax/modal_vendedores.php' data-toggle='modal' data-target='#remoteModal' id='editarProveedor' class="btn btn-primary btn-lg" style="float:right;">Nuevo</a>
			</div>

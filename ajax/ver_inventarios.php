	...
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return llenarGridInvetarioReporteRangosFechas();">
					...
					<div>
						...
						<div class="widget-body no-padding">
								<table id="dt_basic" class="table table-striped table-bordered table-hover" >
									...
									<tbody id="tbodyInventarioReporte">
...
<script type="text/javascript"> 
	...
	function pageConstruirGridInventarios(){
...
<?php
	if(!isset($_REQUEST['tipo']))	{
		echo '<script>llenarGridInvetarioReporte();pageConstruirGridInventarios();</script>';
	}
?>
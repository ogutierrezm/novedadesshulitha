...
?>
<script src="js/piscis/devoluciones.js"/>
	...
	<div class="row">
			...
			<div class="col-sm-4 col-md-4 pull-right">	 
				<fieldset> 
					...
					<button id="btnRptEficiencia" class="btn btn-primary" type="button" onClick ="return llenarGridDevolucionesReporteRangosFechas();">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" >
									<thead>
										<tr>
											...
											<th>PROVEEDOR</th>
											<th>QUIEN REALIZO DEVOLUCI&Oacute;N</th>
											<th>TOTAL DEVOLUCI&Oacute;N</th>
											<th>FECHA COMPRA</th>
											<th>FECHA DEVOLUCI&Oacute;N</th>
										</tr>
									</thead>
									<tbody id="tbodyDevolucionesReporte">
...
<script type="text/javascript"> 
	...
	function pageConstruirGridDevolucion(){
...
<?php
	if(!isset($_REQUEST['tipo']))	{
		echo '<script>llenarGridDevolucionesReporte();pageConstruirGridDevolucion();</script>';
	}
?>
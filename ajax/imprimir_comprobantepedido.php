<?php  
	...
	$vColonia = ISSET($sResultado['colonia'])?$sResultado['colonia']:'';
	$arrayColonia = explode(' - ',$sResultado['colonia']);
	$Colonia = ISSET($arrayColonia[1])?$arrayColonia[1]:'';
?>
<!-- row -->
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">				 
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-16" data-widget-colorbutton="false" data-widget-editbutton="false"	data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="flase" data-widget-sortable="false" >				 
				<header>
					...
					<h2>Impresi&oacute;n de factura #<?PHP echo $folio ; ?></h2>
				</header>
				<div>					
					...
					<div class="widget-body">
						...
						<div class="table-responsive">						 
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center" width="660px">
												<h1 class="font-400">Novedades Adrian</h1>
												<p style="text-align:center;font-size: 15px;"><span class="font-lg">ART&Iacute;CULOS PARA EL HOGAR.</span></p>
												<span style="text-align:center;font-size:11px;">CEL. 6671 03 10 55</span>
											</td>
											<td class="text-center" width="120px">
												<h3>Factura No.<br><span class="txt-color-blue"><?PHP echo $folio ; ?></span></h3>
												<br>
												<h4>Fecha Factura:<br><span class="txt-color-blue"><?php echo date("Y-m-d",strtotime($sResultado['fecha_venta']));  ?></span></h4>
											</td>										 
										</tr> 
									</tbody>
								</table>
							...
							<div class="PrintArea area2 all" id="Retain">
								<table class="table table-hover" width="100%"  style="border: solid 1px #999fff; float: left; padding: 2px; margin-bottom: 2px;">								 
									<tbody style="text-align:left;font-size: 12px;">
										<tr>
											<td class="text-left" style="width:25%"><strong>Cliente:</strong>&nbsp;<?PHP echo $sResultado['nombrecte'] . ' ' .$sResultado['apellidocte'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Tel&eacute;fono:</strong>&nbsp;<?PHP echo $sResultado['telefonocasa'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Celular:</strong>&nbsp;<?PHP echo $sResultado['telefonocelular'] ; ?></td>
											<td class="text-left" style="width:25%" colspan="4"><strong></strong>&nbsp;<?PHP echo $sResultado['telefonocasa'] ; ?></td>
										</tr> 
										<tr>
											...
											<td class="text-left"><strong>Colonia:</strong>&nbsp;<?PHP echo $Colonia ; ?></td>										 
											<td class="text-left" colspan="4"><strong>Observaciones:</strong>&nbsp;<?PHP echo $sResultado['referencias'] ; ?></td>										 
										</tr>										
										<tr>
											<td class="text-left"><strong>Fecha factura:</strong>&nbsp;<?PHP echo $sResultado['fecha_venta'];?></td>
											<td class="text-left"><strong>Tipo de pago:</strong>&nbsp;<?PHP echo $sResultado['nom_tipopago']; ?></td>
											<td class="text-left"><strong>Plazo:</strong>&nbsp;<?PHP echo $sResultado['nom_plazo'] ; ?></td>
											<td class="text-left" colspan="4"><strong>Periodo cobro:</strong>&nbsp;<?PHP echo $sResultado['nom_periodocobro'] ; ?></td>
										</tr>
										<tr>
											<td class="text-left"><strong>Captur&oacute; factura:</strong>&nbsp;<?PHP echo $sResultado['nom_jefegpo'] ; ?></td>
											<td class="text-left"><strong>Vendedor factura:</strong>&nbsp;<?PHP echo $sResultado['nom_ejecutivo'] ; ?></td>
											<td class="text-left"><strong>Supervisor factura:</strong>&nbsp;<?PHP echo $sResultado['nom_supervisor'] ; ?></td>
							...
							<div class="PrintArea area3 all" id="Retain">						 
								...
								<table class="table table-bordered table-hover" width="100%"  style="border: solid 1px #999fff; float: left; padding: 5px; margin-bottom: 5px; text-align:center;">								 
									...
									<thead>
										...
										<?PHP 	$sArticulos = consultarArticulosUnPedidosSinImportarEstatus($folio);
									...
									<tbody>
										...
										<tr>
											<?PHP 
												...
												$TotalNeto =INTVAL($sResultado['total']) ;
										...
										<tr>
											<?PHP 
												...
												ECHO '<td class="text-right" style="text-align:right;"><strong>(-) Abon&oacute;:</strong>&nbsp;$'.$AbonoAnterior.'</td>';
											?>
										</tr> 
										<!--tr>
											< ?PHP 
							...
							<div class="PrintArea area5 all" id="Retain">
								...
								<table class="table table-hover" width="100%"  style="border: solid 1px #999fff; float: left; padding: 2px; margin-bottom: 2px;">								 
									<tbody style="text-align:left;font-size: 12px;">
										<tr>
											<td class="text-left" style="width:25%"><strong>Esposa:</strong>&nbsp;<?PHP echo $sResultado['nombrereferencia1'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Tel&eacute;fono:</strong>&nbsp;<?PHP echo $sResultado['telefonoreferencia1'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Direcci&oacute;n:</strong>&nbsp;<?PHP echo $sResultado['direccionreferencia1'] ; ?></td>
											<td class="text-left" style="width:25%"><strong></strong></td>
										</tr> 
										<tr>
											<td class="text-left" style="width:25%"><strong>Referencia:</strong>&nbsp;<?PHP echo $sResultado['nombrereferencia2'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Tel&eacute;fono:</strong>&nbsp;<?PHP echo $sResultado['telefonoreferencia2'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Direcci&oacute;n:</strong>&nbsp;<?PHP echo $sResultado['direccionreferencia2'] ; ?></td>
											<td class="text-left" style="width:25%"><strong></strong></td>
										</tr>										
										<tr>
											<td class="text-left" style="width:25%"><strong>Aval:</strong>&nbsp;<?PHP echo $sResultado['nombrereferencia3'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Tel&eacute;fono:</strong>&nbsp;<?PHP echo $sResultado['telefonoreferencia3'] ; ?></td>
											<td class="text-left" style="width:25%"><strong>Direcci&oacute;n:</strong>&nbsp;<?PHP echo $sResultado['direccionreferencia3'] ; ?></td>
											<td class="text-left" style="width:25%"><strong></strong></td>
										</tr>
									</tbody>
								</table>
							</div>
							<div class="PrintArea area6 all" id="Retain">
								<!--table class="table table-condensed" width="100%" style="border: solid 1px #999fff; float: left; padding: 5px; margin-bottom: 5px;">								 
									<tbody>
										<tr>										
						...
						<!--div class="row">
							<section class="pull-right">
								...
								<button type="button" class="btn btn-primary" id="btnGrabarPedido" onclick="return ReenviarEmailPedido(<?PHP echo $folio ; ?>);">
						...
						<div class="settingVals">
				            ...
				            <input type="checkbox" class="selPA" value="area6" checked style="display:none"/>
				        </div>
				        <div class="settingVals">
